...
for (let i = 0; i < grades.length; i++) {
    addedGrades = grades[i] + addedGrades;
}
averageGrades = addedGrades / grades.length;
...
function averageGrade(grades) {
    ...
    return addedGrades / grades.length;
}
...
function averageGradeRounded(grades) {
    ...
    const averageGrade = addedGrades / grades.length;
